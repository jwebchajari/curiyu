...
export default function MatchDetail({ match }) {
  ...
  const curiyuTotalPoints = curiyuTryPoints + curiyuConversionPoints + curiyuPenaltyPoints + curiyuTryPenaltyPoints;
  const rivalTotalPoints = rivalTryPoints + rivalConversionPoints + rivalPenaltyPoints + rivalTryPenaltyPoints;
      ...
      <div className="p-6 sm:p-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 mb-8">
          <div className="text-center flex-1">
            ...
            {homeIsCuriyu && (
              <span className="inline-block mt-1 text-xs font-bold text-green-600 uppercase tracking-wide">Curiyú</span>
            )}
          </div>
